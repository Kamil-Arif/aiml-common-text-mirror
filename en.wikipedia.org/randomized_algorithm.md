...
for RP is co-RP. Problem classes having (possibly nonterminating)
...
Where randomness helps When the model of computation is restricted to
...
241--278. Rabin, Michael O. (1980). \"Probabilistic algorithm for
