...
distributions that includes the normal, binomial, Poisson and gamma
...
g(p)=\\Phi \^{-1}(p).\\,\\!} The reason for the use of the probit model
...
more parameters are estimated. Count data Another example of generalized
