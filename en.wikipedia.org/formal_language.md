...
Σ is a subset of Σ\*, that is, a set of words over that alphabet.
...
decision problems is \"it cannot be done at all\", or \"it is extremely
...
system is used to derive one expression from one or more other
