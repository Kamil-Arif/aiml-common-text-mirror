...
\_{\\text{learning rate}}\\cdot {\\bigg (}\\underbrace {\\underbrace
...
than a model that assumes any arbitrary initial condition (AIC). RIC
...
Iterative updates adjust Q towards target values that are only
